...
public final class ResponseNews {
    ...
    @org.jetbrains.annotations.NotNull()
    private java.util.List<com.project.nasa.setting.application.port.out.data.ArticleData> articles;
    ...
    java.util.List<com.project.nasa.setting.application.port.out.data.ArticleData> p0) {
    }
}