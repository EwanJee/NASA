...
public final class RequestNews {
    ...
    @org.jetbrains.annotations.NotNull()
    java.util.List<com.project.nasa.setting.application.port.in.dto.request.news.RequestArticle> articles) {
        super();
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.project.nasa.setting.application.port.in.dto.request.news.RequestArticle> getArticles() {
        return null;
    }
    
    public final void setArticles(@org.jetbrains.annotations.NotNull()
    java.util.List<com.project.nasa.setting.application.port.in.dto.request.news.RequestArticle> p0) {
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.project.nasa.setting.application.port.in.dto.request.news.RequestArticle> component2() {
        return null;
    }
