...
class NewsApiService(
    ...
    override suspend fun getAndPutApi(
        q: String,
        date: LocalDate,
        lang: String,
    ): News {
        val requestNews: RequestNews =
            try {
                newsClient.get()
                    .uri { uriBuilder ->
                        uriBuilder
        ...
        val articles =
            requestNews.articles.map { requestArticle ->
                Article(
